...
== BALORA ~I'll always have friends around me, Helga.~
== X3HelgaB ~That it, then? Relying on friends?~
== BALORA ~Friends make everything possible.~
== X3HelgaB ~That's what a child would think.~
== BALORA ~Why are you being so gruff?~
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaBranwen","GLOBAL",0)~ THEN BBranw X3HelgaBranwen1
...
== BDORN ~I do not fight for your respect, dwarf.~
== X3HelgaB ~But ye have it. Ye have might and stature.~
== BDORN ~Hrm, and here I thought you were going for an insult.~
== X3HelgaB ~Yer only mistake is serving your dark patron. Nay good can come of that.~
== BDORN ~Our arrangement is more beneficial to me than you could understand. And I will not be taking the time to explain why.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaDynaheir","GLOBAL",0)~ THEN BDynah X3HelgaDynaheir1
...
== BDynah ~You mean...literally?~
== X3HelgaB ~Of course not. But I am not going to bathe, finger wiggler.~
== BDynah ~Then do me a favor and stand away.~
EXIT 
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaEdwin","GLOBAL",0)~ THEN BEDWIN X3HelgaEdwin1
...
== BEDWIN ~You insolent dwarf. My magic is more than just the wiggle of fingers. (Not like your insignificant mind would understand.)~
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaEldoth","GLOBAL",0)~ THEN BELDOT X3HelgaEldoth1
...
CombatCounter(0)
!See([ENEMY]) 
Global("X3HelgaFaldorn","GLOBAL",0)~ THEN BFALDO X3HelgaFaldorn1
...
== BFALDO ~Your wretched halls of no air and life?~
== X3HelgaB ~Bah. Trees do have one use I suppose. Good cover.~
== BFALDO ~Your lack of appreciation disgusts me, wretch.~
...
== BGARRI ~A soothed heart is a focused sword.~
== X3HelgaB ~I be focused enough. But I want to be angry with fury.~
== BGARRI ~Perhaps a more inspiring tune for battle?~
...
== BIMOEN ~What's that? I'm not angry, just fighting for <CHARNAME> and our lives.~
== X3HelgaB ~And how ye going to do that with a smile?~
== BIMOEN ~Oh, you know, one grin at a time?~
...
== BJAHEI ~Peace must be fought for like anything else. Even animals fight for their own peace of mind.~
== X3HelgaB ~Bah. What glory can ye bloody find with the scurrying squirrel?~
== BJAHEI ~Not everything is about bloodshed or battle. You would do well to open your mind further, priest.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaKagain","GLOBAL",0)~ THEN BKAGAI X3HelgaKagain1
...
== BKAGAI ~I should have hired ya instead. Cheap, passionate labor is hard to come by.~
...
== BKIVAN ~Be very careful what you say to me, dwarf.~
== X3HelgaB ~I lost mine too.~
== BKIVAN ~And so you are trying to poorly sympathize? I will not rest until Tazok is dead.~
...
== BKIVAN ~I will tell you if I feel the same when he lies dead before me.~
EXIT
...
== BMINSC ~Minsc does not know what you mean, but I also say you have Boo and I's respect in battle~
== X3HelgaB ~Heh. Though how the hell has that little thing survived so many fights?~
== BMINSC ~Do not underestimate Boo. He may be squirrelly sometimes but he knows where to scurry.~
...
== BMONTA ~I could show you quickly your folly, dwarf.~
== X3HelgaB ~I be saying ye be different, halfling. In an approving way.~
== BMONTA ~That saved your neck, dwarf.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaNeera","GLOBAL",0)~ THEN BNEERA X3HelgaNeera1
...
== BNEERA ~It's fine, really it's fine. When is the last time I had an accident again?~
== X3HelgaB ~Far more recent than I'd want to recall, lass.~
== BNEERA ~And was it really that bad? You look fine to me.~
...
== BQUAYL ~Such a streak of violence only shows your simple intelligence.~
== X3HelgaB ~Bah. I'm done with this.~
== BQUAYL ~Too smart for you!~
EXIT
...
== BRASAAD ~Better we could avoid violence. I do not enjoy indulging in it constantly.~
== X3HelgaB ~Then why are you bloody here?~
== BRASAAD ~I am here to aid <CHARNAME> in their efforts. If it can be done without violence, that would be for the best.~
== X3HelgaB ~That'd take all the fun out of it.~
== BRASAAD ~There can be enjoyment in altruism, in helping your enemy see the light, if you wish to try.~
...
== BSAFAN ~And why would I even want that if I could? It'd be hideous.~
== X3HelgaB ~Bah. When I was younger, I sported quite the beard myself. You'd have envied me.~
== BSAFAN ~Uck. Keep your advice of appearances to yourself. I think I know what works.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaSharTeel","GLOBAL",0)~ THEN BSHART X3HelgaSharteel1
...
== BSHART ~You raised a family? With a man?~
== X3HelgaB ~He didn't have a girdle of masculinity if that be what yer implying.~
== BSHART ~And here I thought you were truly admirable.~
...
== BSHART ~You got rid of the useless, dung?~
== X3HelgaB ~Nay. He fell bravely in battle.~
== BSHART ~That made it easy, then.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaSkie","GLOBAL",0)~ THEN BSKIE X3HelgaSkie1
...
== BSKIE ~It will get worse. You're a priestess, can't you make it go away?~ 
== X3HelgaB ~I could try. But I won't bother.~
== BSKIE ~Why are you being so mean?~
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaTiax","GLOBAL",0)~ THEN BTIAX X3HelgaTiax1
...
== BTIAX ~Become a willing servant?~
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaViconia","GLOBAL",0)~ THEN BVICON X3HelgaViconia1
...
== BVICON ~And would they tangle with an ally?~
== X3HelgaB ~Nay. That be the wall between a battle between you and I.~
== BVICON ~You'll find I don't share your enthusiasm for it. I've left you be, now leave me be.~
EXIT
...
== BXANNN ~And then you too, shall die.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaXzar","GLOBAL",0)~ THEN BXZAR X3HelgaXzar1
...
== BXZAR ~Your crushing and carving make it easy to collect samples for future experiments.~
== X3HelgaB ~Listen here, necromancer. Ye want to collect...stuff for your dark work? Make the kill yourself.~
== BXZAR ~Why would I do that when I've the perfect assistant?~
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaYeslick","GLOBAL",0)~ THEN BYESLI X3HelgaYeslick1
~I worry of ye, Helga.~
DO ~SetGlobal("X3HelgaYeslick","GLOBAL",1)~
== X3HelgaB ~Worried? I be no child, Yeslick, even if your concern is kind.~
== BYESLI ~Ye fight with too much fire. Too much anger.~
== X3HelgaB ~And what is bloody hell wrong with that?~
== BYESLI ~I worry blood lust will give in to choosing bloodshed when it is not needed.~
...
== BYESLI ~I am less sure of it. Give me time to judge, lass.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaBranwen","GLOBAL",1)~ THEN BBranw X3HelgaBranwen2
...
== BBranw ~I've seen your scars and wounds. You throw yourself into battle with fury and courage of an entire unit.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaDynaheir","GLOBAL",1)~ THEN BDynah X3HelgaDynaheir2
...
== BDynah ~I can't quite hear thee.~
== X3HelgaB ~Bah. Aye. Aye I did. Might as well hold up some standards if I be traveling with a group.~
== BDynah ~On account of us all I thank thee. Thou should maintain it.~
...
== BIMOEN ~Yeah, it seems to be doing that. So far, anyway.~
== X3HelgaB ~But if ye want to learn fighting right, I'm still here.~
== BIMOEN ~Oh, you mean with a lot of screaming and swinging and hitting my head against my enemies?~
...
== BJAHEI ~I do not fight for your validation, dwarf. Your half-hearted compliment means little to me.~
== X3HelgaB ~What, ye want me to actually say sorry?~
== BJAHEI ~That is your choice, if you wish to admit your earlier error.~
...
== BKAGAI ~Ya putting forward a business proposition?~
...
== BKAGAI ~Torstultok? Thought it was abandoned?~
== X3HelgaB ~For the interests of those there, that be the tale that was woven, aye.~
== BKAGAI ~I'll consider this proposition. If the yield is worthwhile.~
EXIT 
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaMinsc","GLOBAL",1)~ THEN BMinsc X3HelgaMinsc2
...
== BMINSC ~Minsc is wondering though, have you considered a pet hamster?~
== X3HelgaB ~I've got three big grown up hamsters already, Minsc. Nay wishing to have a fourth.~
== BMINSC ~Minsc did not know that the priestess had *three* hamsters.~
== X3HelgaB ~Aye, me children. Dwarves. Metaphor.~
== BMINSC ~You made a hamster? Minsc did not...know such a thing was possible.~
...
== BSHART ~I had nothing further to add.~
...
== BSHART ~Why are you defending these pigs, Helga?~
== X3HelgaB ~I be saying while there are things that are reprehensible, they nay need to be universally loathed.~
== BSHART ~Marriage has blinded you. Here I thought you were a strong woman.~
...
== BYESLI ~Me time has been spent in the Cloakwood, fighting it's beasties. Only a bit before my imprisonment did I travel east.~
== X3HelgaB ~Ye received the warrior's training.~
== BYESLI ~From my father and his father, that I did.~
== X3HelgaB ~I nay did, Yeslick. That be why I fight...differently.~
== BYESLI ~It never be too late to learn, lass. Though ye seem to have grasped what ye needed well enough.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaKagain","GLOBAL",2)~ THEN BKAGAI X3HelgaKagain3
...
== BKAGAI ~How is this profitable, then?~
== X3HelgaB ~Ye find enough lost items of value, I'm sure it will be profitable.~
== BKAGAI ~And what stops me from just taking the more valuable items?~
== X3HelgaB ~Me hammer, for starters.~
== BKAGAI ~This would be for chump change. I think I'll decline.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3HelgaYeslick","GLOBAL",2)~ THEN BYESLI X3HelgaYeslick3
...
== BYESLI ~I be watching ye in and out of battle. I think ye fight hard to hide the strains of your wounds. I see ye tend to yerself during our rests. Ye don't need to compensate, lass.~
== X3HelgaB ~Bah. I would be a fool to call ye a liar. But I will ask this nicely, keep it to yourself.~
== BYESLI ~Do ye need help with your healing, lass?~
== X3HelgaB ~Nay. Some things come with age, as ye know as well as I. But I will not fight like I'm any older, either.~
== BYESLI ~As ye wish, lass. Yer fighting still has my concern, but also my admiration.~ 
EXIT
